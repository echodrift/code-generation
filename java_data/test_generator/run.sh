...
if (( $OPTION == 1 ))
then
python /var/data/lvdthieu/code-generation/java_data/test_generator/run.py --input /var/data/lvdthieu/java-data-final-v2.parquet --base-dir /var/data/lvdthieu/repos/processed-projects --time-limit 20 --output-limit 50 --output
elif (( $OPTION == 2 ))
then 
